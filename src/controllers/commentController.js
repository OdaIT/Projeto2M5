...
const putComment = async (req, res) => {
  try {
    ...
    res.status(404).json({ message: "Error putting comment" });
  }
};
...
const deleteComment = async (req, res) => {
  try {
    ...
    res.status(404).json({ message: "Error deleting a comment" });
  }
};
...
const deleteAllComments = async (req, res) => {
  try {
    ...
    res.status(404).json({ message: "Error deleting all comments" });
  }
};
